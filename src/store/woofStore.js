...
function reducer(state, action) {
 ...
 reviewCount: 0,
 available: true,
 nextSlot: 'Contact to book',
 dogs: 'TBD',
 badge: null,
 bio: '',
 tags: action.payload.services || [],
 verified: false,
 };
 return { ...state, walkers: [...state.walkers, newWalker] };
 }
 default:
 return state;
 }
